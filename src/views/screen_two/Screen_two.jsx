      ...
      <div className="container">
        <div className="about-row">
          ...
          <div className="about-col">
            ...
            <p className="title">
              <i class="fa-solid fa-terminal"></i> I am a software Developer who
              is passionate about learning new technologies. I have excellent
              communication skills and love helping others. I am looking for an
              opportunity where I can apply and grow my IT skills while bringing
              results to the place of employment{" "}
            </p>
